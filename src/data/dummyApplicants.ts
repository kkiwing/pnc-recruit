...
interface RawApplicant {
  id: string; no: number; jobPostingId: string;
  /** 이력서 생성용 시드값일 뿐이다 — Applicant에는 더 이상 team 필드가 없다.
   * "팀"으로 표시되던 화면들은 이제 소속 공고의 JobPosting.field를 그대로
   * 보여주므로(2026-07-21 — team/department/position 필드 통합), 인성검사
   * 경력·자기소개서 문구를 사람마다 다양하게 생성하기 위한 재료로만 남겨뒀다. */
  subTeam: string; name: string; platform: string;
...
const rawApplicants: RawApplicant[] = [
  ...
  {
    id: 'd01-01', no: 1, jobPostingId: 'job-01', subTeam: '프론트엔드', name: '김민준', platform: '사람인', birthYear: '1995', email: 'minjun.kim@gmail.com', phone: '010-1234-5678', region: '서울', regionDetail: '강남구', school: '서울대학교', major: '컴퓨터공학', career: '경력 3년', memo: 'React/TypeScript 능숙', applicationDate: '2026-03-05',
    progress: [
      prog('진행완료'),
      prog('작성완료'),
  ...
  {
    id: 'd01-02', no: 2, jobPostingId: 'job-01', subTeam: '백엔드', name: '이서준', platform: '잡코리아', birthYear: '1993', email: 'seojun.lee@naver.com', phone: '010-2345-6789', region: '경기', regionDetail: '성남시 분당구', school: '카이스트', major: '전산학', career: '경력 5년', memo: 'Java/Spring 전문', applicationDate: '2026-03-06',
    progress: [
      prog('진행완료'),
      prog('작성완료'),
  ...
  {
    id: 'd01-03', no: 3, jobPostingId: 'job-01', subTeam: '프론트엔드', name: '박지호', platform: '링크드인', birthYear: '1997', email: 'jiho.park@gmail.com', phone: '010-3456-7890', region: '서울', regionDetail: '마포구', school: '연세대학교', major: '소프트웨어학', career: '경력 2년', memo: '', applicationDate: '2026-03-07',
    progress: [
      prog('진행완료'),
      prog('작성완료'),
  ...
  {
    id: 'd01-04', no: 4, jobPostingId: 'job-01', subTeam: '백엔드', name: '최예진', platform: '사람인', birthYear: '1998', email: 'yejin.choi@hanmail.net', phone: '010-4567-8901', region: '부산', regionDetail: '해운대구', school: '부산대학교', major: '정보컴퓨터공학', career: '신입', memo: '인턴 경험 있음', applicationDate: '2026-03-08',
  ...
  {
    id: 'd01-05', no: 5, jobPostingId: 'job-01', subTeam: '프론트엔드', name: '정하은', platform: '워크넷', birthYear: '1999', email: 'haeun.jung@gmail.com', phone: '010-5678-9012', region: '인천', regionDetail: '연수구', school: '인하대학교', major: '컴퓨터공학', career: '신입', memo: '', applicationDate: '2026-03-10',
  ...
  {
    id: 'd01-06', no: 6, jobPostingId: 'job-01', subTeam: '백엔드', name: '강도윤', platform: '잡코리아', birthYear: '1994', email: 'doyun.kang@daum.net', phone: '010-6789-0123', region: '대전', regionDetail: '유성구', school: '충남대학교', major: '전자공학', career: '경력 4년', memo: 'AWS 자격증 보유', applicationDate: '2026-03-11',
  ...
  {
    id: 'd01-07', no: 7, jobPostingId: 'job-01', subTeam: '프론트엔드', name: '윤시우', platform: '직접지원', birthYear: '1992', email: 'siwoo.yoon@gmail.com', phone: '010-7890-1234', region: '경기', regionDetail: '수원시 영통구', school: '성균관대학교', major: '소프트웨어학', career: '경력 6년', memo: '시니어급, 팀리드 경험', applicationDate: '2026-03-12',
    progress: [prog('진행완료'), prog('안내'), prog('안내'), prog('안내')],
    submitted: true, isSeparateManagement: false, createdAt: '2026-03-12T09:00:00Z', updatedAt: '2026-03-26T10:00:00Z',
  },
  {
    id: 'd01-08', no: 8, jobPostingId: 'job-01', subTeam: '백엔드', name: '한수민', platform: '인크루트', birthYear: '2000', email: 'sumin.han@naver.com', phone: '010-8901-2345', region: '서울', regionDetail: '동작구', school: '숭실대학교', major: '컴퓨터학부', career: '신입', memo: '', applicationDate: '2026-03-14',
  ...
  {
    id: 'd01-09', no: 9, jobPostingId: 'job-01', subTeam: '프론트엔드', name: '오태현', platform: '사람인', birthYear: '1996', email: 'taehyun.oh@gmail.com', phone: '010-9012-3456', region: '서울', regionDetail: '관악구', school: '서울시립대학교', major: '컴퓨터과학', career: '경력 2년', memo: '', applicationDate: '2026-03-15',
  ...
  {
    id: 'd01-10', no: 10, jobPostingId: 'job-01', subTeam: '백엔드', name: '임채원', platform: '잡코리아', birthYear: '2001', email: 'chaewon.lim@naver.com', phone: '010-0123-4567', region: '강원', regionDetail: '원주시', school: '강원대학교', major: '정보통신', career: '신입', memo: '', applicationDate: '2026-03-18',
    progress: [prog('안내'), prog('안내'), prog('안내'), prog('안내')],
    submitted: true, isSeparateManagement: false, createdAt: '2026-03-18T09:00:00Z', updatedAt: '2026-03-18T10:00:00Z',
  },
  {
    id: 'd01-11', no: 11, jobPostingId: 'job-01', subTeam: '프론트엔드', name: '서유빈', platform: '링크드인', birthYear: '1998', email: 'yubin.seo@gmail.com', phone: '010-1122-3344', region: '경기', regionDetail: '고양시 일산동구', school: '한양대학교', major: '컴퓨터공학', career: '경력 1년', memo: '인성검사 미응시', applicationDate: '2026-03-06',
  ...
  {
    id: 'd01-12', no: 12, jobPostingId: 'job-01', subTeam: '백엔드', name: '조현서', platform: '워크넷', birthYear: '1997', email: 'hyunseo.jo@naver.com', phone: '010-2233-4455', region: '서울', regionDetail: '송파구', school: '건국대학교', major: '소프트웨어학', career: '경력 2년', memo: '개인 사유로 포기', applicationDate: '2026-03-07',
    progress: [prog('진행완료'), prog('안내'), prog('안내'), prog('안내')],
  ...
  {
    id: 'd02-01', no: 13, jobPostingId: 'job-02', subTeam: '콘텐츠마케팅', name: '이서연', platform: '잡코리아', birthYear: '1997', email: 'seoyeon.lee@naver.com', phone: '010-3344-5566', region: '서울', regionDetail: '강서구', school: '고려대학교', major: '미디어학', career: '경력 2년', memo: '영어 능통', applicationDate: '2026-03-12',
    progress: [
      prog('진행완료'),
      prog('작성완료'),
  ...
  {
    id: 'd02-02', no: 14, jobPostingId: 'job-02', subTeam: '퍼포먼스마케팅', name: '박채린', platform: '사람인', birthYear: '1996', email: 'chaerin.park@gmail.com', phone: '010-4455-6677', region: '경기', regionDetail: '안양시 동안구', school: '이화여자대학교', major: '경영학', career: '경력 3년', memo: 'Google Ads 전문', applicationDate: '2026-03-13',
    progress: [
      prog('진행완료'),
      prog('작성완료'),
  ...
  {
    id: 'd02-03', no: 15, jobPostingId: 'job-02', subTeam: '콘텐츠마케팅', name: '신유진', platform: '인크루트', birthYear: '1998', email: 'yujin.shin@gmail.com', phone: '010-5566-7788', region: '서울', regionDetail: '서대문구', school: '중앙대학교', major: '광고홍보', career: '경력 1년', memo: '콘텐츠 제작 경험', applicationDate: '2026-03-14',
    progress: [prog('진행완료'), prog('안내'), prog('안내'), prog('안내')],
    submitted: true, isSeparateManagement: false, createdAt: '2026-03-14T09:00:00Z', updatedAt: '2026-03-30T10:00:00Z',
  },
  {
    id: 'd02-04', no: 16, jobPostingId: 'job-02', subTeam: '브랜드마케팅', name: '강하은', platform: '워크넷', birthYear: '1999', email: 'haeun.kang@naver.com', phone: '010-6677-8899', region: '광주', regionDetail: '서구', school: '전남대학교', major: '국어국문', career: '신입', memo: '', applicationDate: '2026-03-15',
  ...
  {
    id: 'd02-06', no: 18, jobPostingId: 'job-02', subTeam: '브랜드마케팅', name: '문서현', platform: '사람인', birthYear: '1997', email: 'seohyun.moon@gmail.com', phone: '010-8899-0011', region: '서울', regionDetail: '종로구', school: '숙명여자대학교', major: '홍보광고', career: '경력 1년', memo: '', applicationDate: '2026-03-20',
    progress: [prog('안내'), prog('안내'), prog('안내'), prog('안내')],
    submitted: true, isSeparateManagement: false, createdAt: '2026-03-20T09:00:00Z', updatedAt: '2026-03-20T10:00:00Z',
  },
  {
    id: 'd02-07', no: 19, jobPostingId: 'job-02', subTeam: '콘텐츠마케팅', name: '남지원', platform: '링크드인', birthYear: '2000', email: 'jiwon.nam@gmail.com', phone: '010-9900-1122', region: '경기', regionDetail: '파주시', school: '한국외국어대학교', major: '영어학', career: '신입', memo: '영문 콘텐츠 가능', applicationDate: '2026-03-22',
    progress: [prog('안내'), prog('안내'), prog('안내'), prog('안내')],
    submitted: true, isSeparateManagement: false, createdAt: '2026-03-22T09:00:00Z', updatedAt: '2026-03-22T10:00:00Z',
  },
  {
    id: 'd02-08', no: 20, jobPostingId: 'job-02', subTeam: '퍼포먼스마케팅', name: '배수아', platform: '직접지원', birthYear: '1995', email: 'sua.bae@naver.com', phone: '010-0011-2233', region: '서울', regionDetail: '영등포구', school: '서강대학교', major: '경제학', career: '경력 4년', memo: 'Meta Ads 경험', applicationDate: '2026-03-16',
    progress: [prog('진행완료'), prog('안내'), prog('안내'), prog('안내')],
    submitted: true, isSeparateManagement: false, createdAt: '2026-03-16T09:00:00Z', updatedAt: '2026-04-01T10:00:00Z',
  },
  {
    id: 'd02-09', no: 21, jobPostingId: 'job-02', subTeam: '브랜드마케팅', name: '김나현', platform: '사람인', birthYear: '1998', email: 'nahyun.kim@hanmail.net', phone: '010-1133-2244', region: '인천', regionDetail: '남동구', school: '인천대학교', major: '신문방송', career: '신입', memo: '타사 합격으로 포기', applicationDate: '2026-03-13',
    progress: [prog('진행완료'), prog('작성완료'), prog('안내'), prog('안내')],
  ...
  {
    id: 'd03-01', no: 22, jobPostingId: 'job-03', subTeam: 'UX디자인', name: '임나연', platform: '사람인', birthYear: '1997', email: 'nayeon.lim@gmail.com', phone: '010-2244-3355', region: '서울', regionDetail: '용산구', school: '이화여자대학교', major: '디자인학', career: '경력 3년', memo: '포트폴리오 우수', applicationDate: '2026-03-17',
    progress: [
      prog('진행완료'),
      prog('작성완료'),
  ...
  {
    id: 'd03-02', no: 23, jobPostingId: 'job-03', subTeam: 'UI디자인', name: '배현우', platform: '잡코리아', birthYear: '1994', email: 'hyunwoo.bae@naver.com', phone: '010-3355-4466', region: '서울', regionDetail: '서초구', school: '국민대학교', major: '시각디자인', career: '경력 5년', memo: 'Figma 전문', applicationDate: '2026-03-18',
    progress: [
      prog('진행완료'),
      prog('작성완료'),
  ...
  {
    id: 'd03-03', no: 24, jobPostingId: 'job-03', subTeam: '영상디자인', name: '류건우', platform: '링크드인', birthYear: '1996', email: 'gunwoo.ryu@gmail.com', phone: '010-4466-5577', region: '경기', regionDetail: '용인시 수지구', school: '건국대학교', major: '영상디자인', career: '경력 2년', memo: '영상 편집 가능', applicationDate: '2026-03-19',
  ...
  {
    id: 'd03-04', no: 25, jobPostingId: 'job-03', subTeam: 'UX디자인', name: '양소연', platform: '사람인', birthYear: '1999', email: 'soyeon.yang@naver.com', phone: '010-5577-6688', region: '서울', regionDetail: '마포구', school: '홍익대학교', major: 'UX디자인', career: '신입', memo: '', applicationDate: '2026-03-20',
    progress: [prog('진행완료'), prog('안내'), prog('안내'), prog('안내')],
    submitted: true, isSeparateManagement: false, createdAt: '2026-03-20T09:00:00Z', updatedAt: '2026-04-04T10:00:00Z',
  },
  {
    id: 'd03-05', no: 26, jobPostingId: 'job-03', subTeam: 'UI디자인', name: '정민서', platform: '인크루트', birthYear: '2000', email: 'minseo.jung@gmail.com', phone: '010-6688-7799', region: '충북', regionDetail: '청주시 흥덕구', school: '충북대학교', major: '산업디자인', career: '신입', memo: '', applicationDate: '2026-03-22',
    progress: [prog('진행완료'), prog('안내'), prog('안내'), prog('안내')],
    submitted: true, isSeparateManagement: false, createdAt: '2026-03-22T09:00:00Z', updatedAt: '2026-04-06T10:00:00Z',
  },
  {
    id: 'd03-06', no: 27, jobPostingId: 'job-03', subTeam: '영상디자인', name: '노유찬', platform: '워크넷', birthYear: '1998', email: 'yuchan.noh@naver.com', phone: '010-7799-8800', region: '대구', regionDetail: '달서구', school: '계명대학교', major: '멀티미디어', career: '경력 1년', memo: '', applicationDate: '2026-03-24',
    progress: [prog('공고등록'), prog('안내'), prog('안내'), prog('안내')],
    submitted: true, isSeparateManagement: false, createdAt: '2026-03-24T09:00:00Z', updatedAt: '2026-03-30T10:00:00Z',
  },
  {
    id: 'd03-07', no: 28, jobPostingId: 'job-03', subTeam: 'UX디자인', name: '황지유', platform: '사람인', birthYear: '2001', email: 'jiyu.hwang@gmail.com', phone: '010-8800-9911', region: '서울', regionDetail: '성동구', school: '동국대학교', major: '시각디자인', career: '신입', memo: '', applicationDate: '2026-03-26',
    progress: [prog('안내'), prog('안내'), prog('안내'), prog('안내')],
    submitted: true, isSeparateManagement: false, createdAt: '2026-03-26T09:00:00Z', updatedAt: '2026-03-26T10:00:00Z',
  },
  {
    id: 'd03-08', no: 29, jobPostingId: 'job-03', subTeam: 'UI디자인', name: '송다은', platform: '잡코리아', birthYear: '1995', email: 'daeun.song@naver.com', phone: '010-9911-0022', region: '경기', regionDetail: '성남시 중원구', school: '세종대학교', major: '디자인이노베이션', career: '경력 3년', memo: '면접 후 타사 입사로 포기', applicationDate: '2026-03-17',
    progress: [
      prog('진행완료'),
      prog('작성완료'),
  ...
  {
    id: 'd04-01', no: 30, jobPostingId: 'job-04', subTeam: '서비스기획', name: '서지민', platform: '링크드인', birthYear: '1996', email: 'jimin.seo@gmail.com', phone: '010-1010-2020', region: '서울', regionDetail: '송파구', school: '연세대학교', major: '경제학', career: '경력 3년', memo: '', applicationDate: '2026-03-22',
    progress: [
      prog('진행완료'),
      prog('작성완료'),
  ...
  {
    id: 'd04-02', no: 31, jobPostingId: 'job-04', subTeam: '인사', name: '최수빈', platform: '사람인', birthYear: '1996', email: 'subin.choi@hanmail.net', phone: '010-2020-3030', region: '인천', regionDetail: '연수구', school: '인하대학교', major: '심리학', career: '경력 2년', memo: '', applicationDate: '2026-03-23',
    progress: [prog('진행완료'), prog('작성완료'), prog('안내'), prog('안내')],
    submitted: true, isSeparateManagement: false, createdAt: '2026-03-23T09:00:00Z', updatedAt: '2026-04-09T10:00:00Z',
  },
  {
    id: 'd04-03', no: 32, jobPostingId: 'job-04', subTeam: '서비스기획', name: '한도윤', platform: '잡코리아', birthYear: '1994', email: 'doyun.han@daum.net', phone: '010-3030-4040', region: '대전', regionDetail: '유성구', school: '한국과학기술원', major: '산업공학', career: '경력 4년', memo: '전 직장 추천서 있음', applicationDate: '2026-03-24',
  ...
  {
    id: 'd04-04', no: 33, jobPostingId: 'job-04', subTeam: '인사', name: '오준혁', platform: '인크루트', birthYear: '1995', email: 'junhyuk.oh@naver.com', phone: '010-4040-5050', region: '대구', regionDetail: '수성구', school: '경북대학교', major: '행정학', career: '경력 3년', memo: '대구 거주, 서울 이전 가능', applicationDate: '2026-03-25',
    progress: [prog('진행완료'), prog('안내'), prog('안내'), prog('안내')],
    submitted: true, isSeparateManagement: false, createdAt: '2026-03-25T09:00:00Z', updatedAt: '2026-04-09T10:00:00Z',
  },
  {
    id: 'd04-05', no: 34, jobPostingId: 'job-04', subTeam: '서비스기획', name: '권태현', platform: '직접지원', birthYear: '1993', email: 'taehyun.kwon@daum.net', phone: '010-5050-6060', region: '경남', regionDetail: '창원시 성산구', school: '부산대학교', major: '경영정보', career: '경력 5년', memo: '기획서 우수', applicationDate: '2026-03-26',
    progress: [prog('진행완료'), prog('안내'), prog('안내'), prog('안내')],
    submitted: true, isSeparateManagement: false, createdAt: '2026-03-26T09:00:00Z', updatedAt: '2026-04-10T10:00:00Z',
  },
  {
    id: 'd04-06', no: 35, jobPostingId: 'job-04', subTeam: '인사', name: '문서현', platform: '사람인', birthYear: '1997', email: 'seohyun2.moon@naver.com', phone: '010-6060-7070', region: '울산', regionDetail: '남구', school: '울산대학교', major: '사회학', career: '경력 1년', memo: '', applicationDate: '2026-03-28',
    progress: [prog('공고등록'), prog('안내'), prog('안내'), prog('안내')],
    submitted: true, isSeparateManagement: false, createdAt: '2026-03-28T09:00:00Z', updatedAt: '2026-04-02T10:00:00Z',
  },
  {
    id: 'd04-07', no: 36, jobPostingId: 'job-04', subTeam: '서비스기획', name: '유하진', platform: '워크넷', birthYear: '2000', email: 'hajin.yoo@gmail.com', phone: '010-7070-8080', region: '서울', regionDetail: '노원구', school: '광운대학교', major: '경영학', career: '신입', memo: '', applicationDate: '2026-03-30',
    progress: [prog('안내'), prog('안내'), prog('안내'), prog('안내')],
    submitted: true, isSeparateManagement: false, createdAt: '2026-03-30T09:00:00Z', updatedAt: '2026-03-30T10:00:00Z',
  },
  {
    id: 'd04-08', no: 37, jobPostingId: 'job-04', subTeam: '인사', name: '백지안', platform: '잡코리아', birthYear: '1998', email: 'jian.baek@naver.com', phone: '010-8080-9090', region: '경기', regionDetail: '화성시', school: '아주대학교', major: '행정학', career: '경력 1년', memo: '자사양식 미제출', applicationDate: '2026-03-23',
  ...
  {
    id: 'd04-09', no: 38, jobPostingId: 'job-04', subTeam: '서비스기획', name: '고은채', platform: '사람인', birthYear: '1999', email: 'eunchae.go@gmail.com', phone: '010-9090-0101', region: '서울', regionDetail: '강동구', school: '동덕여자대학교', major: '국제경영', career: '신입', memo: '개인 사유로 포기', applicationDate: '2026-03-24',
    progress: [prog('진행완료'), prog('안내'), prog('안내'), prog('안내')],
  ...
  {
    id: 'd05-01', no: 39, jobPostingId: 'job-05', subTeam: '재무분석', name: '장윤호', platform: '사람인', birthYear: '1994', email: 'yunho.jang@gmail.com', phone: '010-1212-3434', region: '서울', regionDetail: '여의도동', school: '서울대학교', major: '경영학', career: '경력 4년', memo: 'CPA 자격증 보유', applicationDate: '2026-03-27',
  ...
  {
    id: 'd05-02', no: 40, jobPostingId: 'job-05', subTeam: '회계', name: '민소희', platform: '잡코리아', birthYear: '1996', email: 'sohee.min@naver.com', phone: '010-3434-5656', region: '경기', regionDetail: '의정부시', school: '고려대학교', major: '회계학', career: '경력 2년', memo: '', applicationDate: '2026-03-28',
    progress: [prog('완료'), prog('완료'), prog('진행중'), prog('대기')],
    submitted: true, isSeparateManagement: false, createdAt: '2026-03-28T09:00:00Z', updatedAt: '2026-04-12T10:00:00Z',
  },
  {
    id: 'd05-03', no: 41, jobPostingId: 'job-05', subTeam: '재무분석', name: '차준영', platform: '링크드인', birthYear: '1995', email: 'junyoung.cha@gmail.com', phone: '010-5656-7878', region: '서울', regionDetail: '강남구', school: '성균관대학교', major: '경제학', career: '경력 3년', memo: '재무모델링 경험', applicationDate: '2026-03-29',
  ...
  {
    id: 'd05-04', no: 42, jobPostingId: 'job-05', subTeam: '회계', name: '표지혜', platform: '사람인', birthYear: '1998', email: 'jihye.pyo@naver.com', phone: '010-7878-9090', region: '충남', regionDetail: '천안시 동남구', school: '단국대학교', major: '세무회계', career: '신입', memo: '', applicationDate: '2026-03-31',
  ...
  {
    id: 'd05-05', no: 43, jobPostingId: 'job-05', subTeam: '재무분석', name: '김다인', platform: '직접지원', birthYear: '2000', email: 'dain.kim@gmail.com', phone: '010-9090-1212', region: '서울', regionDetail: '광진구', school: '한양대학교', major: '파이낸스', career: '신입', memo: '', applicationDate: '2026-04-02',
  ...
  {
    id: 'd05-06', no: 44, jobPostingId: 'job-05', subTeam: '회계', name: '윤재민', platform: '워크넷', birthYear: '1997', email: 'jaemin.yoon@naver.com', phone: '010-1313-2424', region: '경기', regionDetail: '부천시', school: '가톨릭대학교', major: '회계학', career: '경력 1년', memo: '', applicationDate: '2026-04-03',
    progress: [prog('대기'), prog('대기'), prog('대기'), prog('대기')],
    submitted: true, isSeparateManagement: false, createdAt: '2026-04-03T09:00:00Z', updatedAt: '2026-04-03T10:00:00Z',
  },
  {
    id: 'd05-07', no: 45, jobPostingId: 'job-05', subTeam: '재무분석', name: '성하람', platform: '잡코리아', birthYear: '1996', email: 'haram.sung@gmail.com', phone: '010-2424-3535', region: '서울', regionDetail: '중구', school: '서울시립대학교', major: '세무학', career: '경력 2년', memo: '면접 당일 취소', applicationDate: '2026-03-27',
    progress: [
      prog('완료'),
      prog('완료'),
  ...
  {
    id: 'd06-01', no: 46, jobPostingId: 'job-06', subTeam: '데이터분석', name: '양지수', platform: '링크드인', birthYear: '1991', email: 'jisoo.yang@gmail.com', phone: '010-3535-4646', region: '서울', regionDetail: '강서구', school: '서울대학교', major: '통계학', career: '경력 5년', memo: 'Python/SQL 전문', applicationDate: '2026-04-02',
    progress: [prog('진행완료'), prog('작성완료'), prog('안내'), prog('안내')],
    submitted: true, isSeparateManagement: false, createdAt: '2026-04-02T09:00:00Z', updatedAt: '2026-04-14T10:00:00Z',
  },
  {
    id: 'd06-02', no: 47, jobPostingId: 'job-06', subTeam: '데이터엔지니어링', name: '조은서', platform: '사람인', birthYear: '1997', email: 'eunseo.jo@naver.com', phone: '010-4646-5757', region: '경기', regionDetail: '안산시 상록구', school: '한양대학교', major: '데이터사이언스', career: '경력 2년', memo: 'Spark 경험', applicationDate: '2026-04-03',
    progress: [prog('진행완료'), prog('안내'), prog('안내'), prog('안내')],
    submitted: true, isSeparateManagement: false, createdAt: '2026-04-03T09:00:00Z', updatedAt: '2026-04-14T10:00:00Z',
  },
  {
    id: 'd06-03', no: 48, jobPostingId: 'job-06', subTeam: '데이터분석', name: '이하율', platform: '잡코리아', birthYear: '1999', email: 'hayul.lee@gmail.com', phone: '010-5757-6868', region: '서울', regionDetail: '관악구', school: '서울대학교', major: '수학', career: '신입', memo: '석사 졸업', applicationDate: '2026-04-04',
    progress: [prog('진행완료'), prog('안내'), prog('안내'), prog('안내')],
    submitted: true, isSeparateManagement: false, createdAt: '2026-04-04T09:00:00Z', updatedAt: '2026-04-14T10:00:00Z',
  },
  {
    id: 'd06-04', no: 49, jobPostingId: 'job-06', subTeam: '데이터엔지니어링', name: '박준서', platform: '워크넷', birthYear: '1998', email: 'junseo.park@naver.com', phone: '010-6868-7979', region: '세종', regionDetail: '한솔동', school: '충북대학교', major: '정보통신공학', career: '경력 1년', memo: '', applicationDate: '2026-04-05',
    progress: [prog('공고등록'), prog('안내'), prog('안내'), prog('안내')],
    submitted: true, isSeparateManagement: false, createdAt: '2026-04-05T09:00:00Z', updatedAt: '2026-04-10T10:00:00Z',
  },
  {
    id: 'd06-05', no: 50, jobPostingId: 'job-06', subTeam: '데이터분석', name: '김서윤', platform: '사람인', birthYear: '2001', email: 'seoyun.kim2@gmail.com', phone: '010-7979-8080', region: '서울', regionDetail: '중랑구', school: '국민대학교', major: '빅데이터', career: '신입', memo: '', applicationDate: '2026-04-07',
    progress: [prog('안내'), prog('안내'), prog('안내'), prog('안내')],
    submitted: true, isSeparateManagement: false, createdAt: '2026-04-07T09:00:00Z', updatedAt: '2026-04-07T10:00:00Z',
  },
  {
    id: 'd06-06', no: 51, jobPostingId: 'job-06', subTeam: '데이터엔지니어링', name: '정우진', platform: '인크루트', birthYear: '1996', email: 'woojin.jung@daum.net', phone: '010-8080-9191', region: '전북', regionDetail: '전주시 덕진구', school: '전북대학교', major: '컴퓨터공학', career: '경력 2년', memo: 'ETL 파이프라인 경험', applicationDate: '2026-04-08',
    progress: [prog('안내'), prog('안내'), prog('안내'), prog('안내')],
    submitted: true, isSeparateManagement: false, createdAt: '2026-04-08T09:00:00Z', updatedAt: '2026-04-08T10:00:00Z',
  },
  {
    id: 'd06-07', no: 52, jobPostingId: 'job-06', subTeam: '데이터분석', name: '안서현', platform: '직접지원', birthYear: '2000', email: 'seohyun.ahn@gmail.com', phone: '010-9191-0202', region: '경기', regionDetail: '하남시', school: '경희대학교', major: '응용통계', career: '신입', memo: '', applicationDate: '2026-04-10',
    progress: [prog('안내'), prog('안내'), prog('안내'), prog('안내')],
    submitted: false, isSeparateManagement: false, createdAt: '2026-04-10T09:00:00Z', updatedAt: '2026-04-10T10:00:00Z',
  },
  {
    id: 'd06-08', no: 53, jobPostingId: 'job-06', subTeam: '데이터분석', name: '구민재', platform: '잡코리아', birthYear: '1998', email: 'minjae.gu@naver.com', phone: '010-0202-1313', region: '서울', regionDetail: '동대문구', school: '세종대학교', major: '데이터사이언스', career: '경력 1년', memo: '지원 포기 연락', applicationDate: '2026-04-03',
...
function buildCareers(raw: RawApplicant): CareerEntry[] {
  ...
  const role = ROLE_BY_TEAM[raw.subTeam] || `${raw.subTeam} 담당자`;
  ...
  for (let i = 0; i < numCompanies; i++) {
    ...
    entries.unshift({
      ...
      description: `${role}로서 ${raw.subTeam} 관련 실무를 담당했습니다.`,
    });
    cursor = start;
  }
  return entries;
...
function buildCoverLetter(raw: RawApplicant): CoverLetterAnswer[] {
  const role = ROLE_BY_TEAM[raw.subTeam] || raw.subTeam;
  const answers = [
    `${raw.school}에서 ${raw.major} 전공을 통해 쌓은 역량을 바탕으로 ${role} 직무에 기여하고 싶어 지원하게 되었습니다.`,
    `${raw.subTeam} 분야는 실제 사용자의 문제를 데이터와 논리로 풀어나가는 과정이 매력적이라고 느껴 흥미를 갖게 되었습니다.`,
